...
See the library in use at:  [```example/specs/atomicFileWritingSpec.js```](example/specs/atomicFileWritingSpec.js)
...
<img src="./assets/appLandingScreen.png" alt="AtomicFileOps Landing Screen" width="200"/>
